...
public class ArtifactAuditLog {
    ...
    @Column(name = "actor_user", nullable = false) private String actorUser;
    ...
    public String getActorUser() { return actorUser; } public void setActorUser(String v) { actorUser = v; }
