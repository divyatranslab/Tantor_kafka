...
c = sub_re(c, r"\{item\.icon && \{\(item\.icon as any\)\(\{ size: 15, className: 'nav-item-icon' \}\)\}\}", "{item.icon && ((item.icon as any)({ size: 15, className: 'nav-item-icon' }))}", 'Sidebar fix icon 1')
c = sub_re(c, r"\{item\.icon && \{\(item\.icon as any\)\(\{ size: 20, className: 'nav-item-icon' \}\)\}\}", "{item.icon && ((item.icon as any)({ size: 20, className: 'nav-item-icon' }))}", 'Sidebar fix icon 2')
