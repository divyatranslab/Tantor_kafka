...
class SecurityConfigAuthorizationTest {
    ...
    @Test
    void agentBoundaryCannotBeCrossedByAnonymousOrUserJwtRequests() throws Exception {
        mockMvc.perform(post("/api/v1/agents/register")).andExpect(status().isUnauthorized());
